...
const name_item = document.querySelectorAll('.fw-bolder');
const search_item = document.getElementById('search-item');
const element_cakes = document.querySelectorAll('.text-center');
...
const infor = document.querySelectorAll('.text-center');
...
for (var i = 0; i < add_cart.length; i++) {
  ...
  add.addEventListener("click", function (event) {
    ...
    var product = button.par;
    var img = product.getElementsByClassName("card-img-top").src
    var title = product.getElementsByClassName("product-name").innerText
